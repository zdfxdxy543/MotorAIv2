    ...
    profiles = [
        {
            ...
            "preferred_control_methods": [],
            "generation_strategy": {
                "stage": "generate",
                "current_mode": "template_merge_v1",
                "current_scope": "当前稳定生成器主要选择 current_loop + mech_loop 及 pid/ladrc 方法标记，再由模板合并生成 ctl_main.c。",
        ...
        },
        {
            ...
            "generation_strategy": {
                ...
                "current_mode": "template_merge_v1",
                "current_scope": "当前稳定生成器主要选择 current_loop + mech_loop 及 pid/ladrc 方法标记，再由模板合并生成 ctl_main.c。",
                "future_modes": ["full_controller_generation", "disturbance_observer", "ladrc"],
            },
            "optimize_policy": "shared_metrics_shared_scoring",
        },
        {
